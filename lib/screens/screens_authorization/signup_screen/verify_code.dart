...
class VerifyCodeScreen extends StatefulWidget {
  ...
  const VerifyCodeScreen({super.key, required this.email, required this.otp});
      ...
      child: Column(
        ...
        children: [
          ...
          VerificationCodeField(
            length: 6,
            onFilled: (value) => print('otp filled is $value and real otp is $otp'),
          ...
          Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () async {
                  String newOtp =
                      await AuthenService.verifyEmailRegister(userEmail);
                  setState(() {
                    otp = newOtp;
                  });
                },
